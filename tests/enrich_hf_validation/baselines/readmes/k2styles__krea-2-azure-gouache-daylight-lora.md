...
instance_prompt: azure gouache daylight style
tags:
- lora
- text-to-image
- krea
...
- painterly
widget:
- text: "a cat asleep on a windowsill. azure gouache daylight style"
  output:
    url: images/ex_1.png
- text: "a horse in a misty meadow. azure gouache daylight style"
  output:
    url: images/ex_2.png
- text: "a horse in a misty meadow. azure gouache daylight style"
  output:
    url: images/ex_3.png
- text: "a city skyline at night. azure gouache daylight style"
  output:
    url: images/ex_4.png
- text: "a cozy cafe interior. azure gouache daylight style"
  output:
    url: images/ex_5.png
- text: "a field of wildflowers. azure gouache daylight style"
  output:
    url: images/ex_6.png
---
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://huggingface.co/ilkerzgi/krea-2-azure-gouache-daylight-lora/resolve/main/fal-dark.png">
  <img src="https://huggingface.co/ilkerzgi/krea-2-azure-gouache-daylight-lora/resolve/main/fal-light.png" alt="fal" height="18">
</picture>

# Azure Gouache Daylight

**fal · Krea 2 Style LoRA series.** One of 1600+ style LoRAs trained on [fal](https://fal.ai).

A **Krea 2** style LoRA. Add the trigger **`azure gouache daylight style`** to the end of your prompt.
...
| Parameter | Value |
|-----------|-------|
| Trigger | `azure gouache daylight style` |
...
result = fal_client.subscribe(
    ...
    arguments={
        "prompt": "a lighthouse on a rocky cliff. azure gouache daylight style",
        "loras": [{"path": "https://huggingface.co/ilkerzgi/krea-2-azure-gouache-daylight-lora/resolve/main/azure-gouache-daylight.safetensors", "scale": 1.0}],
...
result = fal_client.subscribe(
    ...
    arguments={
        ...
        "trigger_phrase": "azure gouache daylight style",
        "steps": 100,
