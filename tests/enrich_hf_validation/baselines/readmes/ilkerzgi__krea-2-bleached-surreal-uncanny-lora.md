...
instance_prompt: bleached surreal uncanny style
tags:
- lora
- text-to-image
- krea
...
- cinematic
widget:
- text: "a lighthouse on a rocky cliff. bleached surreal uncanny style"
  output:
    url: images/ex_1.png
- text: "a lighthouse on a rocky cliff. bleached surreal uncanny style"
  output:
...
---
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://huggingface.co/ilkerzgi/krea-2-bleached-surreal-uncanny-lora/resolve/main/fal-dark.png">
  <img src="https://huggingface.co/ilkerzgi/krea-2-bleached-surreal-uncanny-lora/resolve/main/fal-light.png" alt="fal" height="18">
</picture>

# Bleached Surreal Uncanny

**fal · Krea 2 Style LoRA series.** One of 1600+ style LoRAs trained on [fal](https://fal.ai).

A **Krea 2** style LoRA. Add the trigger **`bleached surreal uncanny style`** to the end of your prompt.
...
| Parameter | Value |
|-----------|-------|
| Trigger | `bleached surreal uncanny style` |
...
result = fal_client.subscribe(
    ...
    arguments={
        "prompt": "a lighthouse on a rocky cliff. bleached surreal uncanny style",
        "loras": [{"path": "https://huggingface.co/ilkerzgi/krea-2-bleached-surreal-uncanny-lora/resolve/main/bleached-surreal-uncanny.safetensors", "scale": 1.0}],
...
result = fal_client.subscribe(
    ...
    arguments={
        ...
        "trigger_phrase": "bleached surreal uncanny style",
        "steps": 100,
...
A ComfyUI-compatible copy of the weights is included in this repo: **`bleached-surreal-uncanny-comfy.safetensors`**. It is the
...
any other LoRA. The original `bleached-surreal-uncanny.safetensors` is for [fal](https://fal.ai) / diffusers.
