...
instance_prompt: airy gouache minimalist style
tags:
- lora
- text-to-image
- krea
...
- illustration
widget:
- text: "a lighthouse on a rocky cliff. airy gouache minimalist style"
  output:
    url: images/ex_1.png
- text: "a lighthouse on a rocky cliff. airy gouache minimalist style"
  output:
...
---
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://huggingface.co/ilkerzgi/krea-2-airy-gouache-minimalist-lora/resolve/main/fal-dark.png">
  <img src="https://huggingface.co/ilkerzgi/krea-2-airy-gouache-minimalist-lora/resolve/main/fal-light.png" alt="fal" height="18">
</picture>

# Airy Gouache Minimalist

**fal · Krea 2 Style LoRA series.** One of 1600+ style LoRAs trained on [fal](https://fal.ai).

A **Krea 2** style LoRA. Add the trigger **`airy gouache minimalist style`** to the end of your prompt.
...
| Parameter | Value |
|-----------|-------|
| Trigger | `airy gouache minimalist style` |
...
result = fal_client.subscribe(
    ...
    arguments={
        "prompt": "a lighthouse on a rocky cliff. airy gouache minimalist style",
        "loras": [{"path": "https://huggingface.co/ilkerzgi/krea-2-airy-gouache-minimalist-lora/resolve/main/airy-gouache-minimalist.safetensors", "scale": 1.0}],
...
result = fal_client.subscribe(
    ...
    arguments={
        ...
        "trigger_phrase": "airy gouache minimalist style",
        "steps": 100,
...
A ComfyUI-compatible copy of the weights is included in this repo: **`airy-gouache-minimalist-comfy.safetensors`**. It is the
...
any other LoRA. The original `airy-gouache-minimalist.safetensors` is for [fal](https://fal.ai) / diffusers.
