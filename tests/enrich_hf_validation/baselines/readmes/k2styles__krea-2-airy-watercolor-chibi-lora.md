...
instance_prompt: airy watercolor chibi style
tags:
- lora
- text-to-image
- krea
...
- illustration
widget:
- text: "a lighthouse on a rocky cliff. airy watercolor chibi style"
  output:
    url: images/ex_1.png
- text: "a lighthouse on a rocky cliff. airy watercolor chibi style"
  output:
...
---
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://huggingface.co/ilkerzgi/krea-2-airy-watercolor-chibi-lora/resolve/main/fal-dark.png">
  <img src="https://huggingface.co/ilkerzgi/krea-2-airy-watercolor-chibi-lora/resolve/main/fal-light.png" alt="fal" height="18">
</picture>

# Airy Watercolor Chibi

**fal · Krea 2 Style LoRA series.** One of 1600+ style LoRAs trained on [fal](https://fal.ai).

A **Krea 2** style LoRA. Add the trigger **`airy watercolor chibi style`** to the end of your prompt.
...
| Parameter | Value |
|-----------|-------|
| Trigger | `airy watercolor chibi style` |
...
result = fal_client.subscribe(
    ...
    arguments={
        "prompt": "a lighthouse on a rocky cliff. airy watercolor chibi style",
        "loras": [{"path": "https://huggingface.co/ilkerzgi/krea-2-airy-watercolor-chibi-lora/resolve/main/airy-watercolor-chibi.safetensors", "scale": 1.0}],
...
result = fal_client.subscribe(
    ...
    arguments={
        ...
        "trigger_phrase": "airy watercolor chibi style",
        "steps": 100,
